...
@interface AWDBasebandPowerToolKPIs : PBCodable <NSCopying> {
	...
	SCD_Struct_AW4* _armUtilityPDFs;
	SCD_Struct_AW4* _causeCodeBackgroundActivityARMUtilitys;
	SCD_Struct_AW4* _causeCodeBackgroundActivityDurations;
	SCD_Struct_AW4* _causeCodeCumulativeARMUtilitys;
	SCD_Struct_AW4* _causeCodeCumulativeDurations;
	SCD_Struct_AW4* _causeCodeMarginalCoverageARMUtilitys;
	SCD_Struct_AW4* _causeCodeMarginalCoverageDurations;
	SCD_Struct_AW4* _causeCodeOOSARMUtilitys;
	SCD_Struct_AW4* _causeCodeOOSDurations;
	SCD_Struct_AW4* _causeCodeRACHFailARMUtilitys;
	SCD_Struct_AW4* _causeCodeRACHFailDurations;
	SCD_Struct_AW4* _causeCodeStruckInDCHARMUtilitys;
	SCD_Struct_AW4* _causeCodeStruckInDCHDurations;
	SCD_Struct_AW4* _causeCodeTcXONotShuttingARMUtilitys;
	SCD_Struct_AW4* _causeCodeTcXONotShuttingDurations;
	SCD_Struct_AW4* _causeCodeUnknownARMUtilitys;
	SCD_Struct_AW4* _causeCodeUnknownDurations;
