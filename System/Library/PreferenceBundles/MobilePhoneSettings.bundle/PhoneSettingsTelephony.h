...
@interface PhoneSettingsTelephony : NSObject {
	...
	SCD_Struct_Ph1* callForwardingSettingsUnconditional;
	SCD_Struct_Ph1* callForwardingSettingsMobileBusy;
	SCD_Struct_Ph1* callForwardingSettingsNoReply;
	SCD_Struct_Ph1* callForwardingSettingsNotReachable;
...
-(SCD_Struct_Ph2*)_callForwardingSettingsForForwardingReason:(id)arg1 ;
