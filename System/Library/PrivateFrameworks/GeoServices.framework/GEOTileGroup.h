...
@interface GEOTileGroup : PBCodable <NSCopying> {
	...
	SCD_Struct_GE67* _regionalResourceIndexs;
	unsigned long long _regionalResourceIndexsCount;
	unsigned long long _regionalResourceIndexsSpace;
	SCD_Struct_GE62* _attributionIndexs;
	SCD_Struct_GE62* _fontIndexs;
	SCD_Struct_GE62* _iconIndexs;
	SCD_Struct_GE62* _styleSheetIndexs;
	SCD_Struct_GE62* _textureIndexs;
	SCD_Struct_GE62* _xmlIndexs;
	SCD_Struct_GE82* _tileSets;
...
@property (nonatomic,readonly) SCD_Struct_GE82* tileSets; 
...
@property (nonatomic,readonly) SCD_Struct_GE67* regionalResourceIndexs; 
...
-(void)addTileSet:(SCD_Struct_GE82)arg1 ;
-(unsigned long long)tileSetsCount;
-(void)clearTileSets;
-(SCD_Struct_GE82)tileSetAtIndex:(unsigned long long)arg1 ;
-(SCD_Struct_GE82*)tileSets;
...
-(SCD_Struct_GE67)regionalResourceIndexAtIndex:(unsigned long long)arg1 ;
-(void)addRegionalResourceIndex:(SCD_Struct_GE67)arg1 ;
...
-(void)setTileSets:(SCD_Struct_GE82*)arg1 count:(unsigned long long)arg2 ;
...
-(SCD_Struct_GE67*)regionalResourceIndexs;
-(void)setRegionalResourceIndexs:(SCD_Struct_GE67*)arg1 count:(unsigned long long)arg2 ;
-(unsigned*)xmlIndexs;
