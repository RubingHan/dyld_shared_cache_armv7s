...
-(unsigned long long)partDefinitionCountForElementDefinition:(const SCD_Struct_CU22*)arg1 ;
-(unsigned long long)dimensionDefinitionCountForPartDefinition:(const SCD_Struct_CU21*)arg1 ;
-(const SCD_Struct_CU22*)elementDefinitionWithName:(id)arg1 ;
-(const SCD_Struct_CU21*)partDefinitionWithName:(id)arg1 forElementDefinition:(const SCD_Struct_CU22*)arg2 ;
-(id)widgetNameForPartDefinition:(const SCD_Struct_CU21*)arg1 ;
-(const SCD_Struct_CU21*)partDefinitionForWidgetName:(id)arg1 ;
...
-(unsigned long long)partDefinitionCountForEffectDefinition:(const SCD_Struct_CU22*)arg1 ;
