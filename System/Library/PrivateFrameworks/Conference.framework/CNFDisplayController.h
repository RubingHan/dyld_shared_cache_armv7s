...
@class IMAVChat, UIControl, UIView, CNFVideoGroupView, _UIBackdropView, CNFStatusBarGradientView, UIActivityIndicatorView, UILabel, NSTimer, NSString, UIImage, CNFInterfaceOverlayView, TPLCDView, TPSuperBottomBar, UIActionSheet, CNFAlertView, NSObject, IMAVChatParticipant;
...
-(CGRect)_boundsForLocalMutedViewInLocalOrientation:(long long)arg1 ;
-(void)_adjustForOrientationAnimated:(bool)arg1 completion:(/*^block*/ id)arg2 ;
-(void)_deviceOrientationDidChange:(id)arg1 ;
-(CGSize)_normalizedScreenSizeForOrientation:(long long)arg1 ;
-(long long)_deviceOrientationForIMAVCameraOrientation:(unsigned)arg1 ;
-(bool)_fillRemoteVideoOnScreenWithLocalOrientation:(long long)arg1 remoteAspectRatio:(CGSize)arg2 ;
-(double)_angleForLocalOrientation:(long long)arg1 remoteOrientation:(long long)arg2 ;
-(CGRect)_boundsForRemoteVideoInLocalOrientation:(long long)arg1 ;
-(void)_resetPIPToFullScreen;
-(CGRect)_cornerLocationsRectForOrientation:(long long)arg1 ;
...
-(id)_viewWithCenteredImage:(id)arg1 title:(id)arg2 fontSize:(double)arg3 bounds:(CGRect)arg4 center:(CGPoint)arg5 ;
