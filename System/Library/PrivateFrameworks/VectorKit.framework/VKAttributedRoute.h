...
-(PolylineCoordinate)_findRouteCoordinateWithOffset:(float)arg1 aPos:(const Vec2Imp<float>*)arg2 aCoord:(const PolylineCoordinate*)arg3 bCoord:(const PolylineCoordinate*)arg4 pointOnSegment:(Vec2Imp<float>)arg5 bounds:(const VKEdgeInsets*)arg6 ;
...
-(CGPoint)locationAtDistance:(double)arg1 from:(id)arg2 ;
@end
