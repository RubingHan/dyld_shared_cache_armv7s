...
@interface VKCamera : NSObject {
	...
	SCD_Struct_VK42 _projectionMatrixUnscaledWithoutOffset;
...
@property (nonatomic,readonly) const SCD_Struct_VK42* projectionMatrixUnscaledWithoutOffset; 
...
-(const SCD_Struct_VK42*)projectionMatrixUnscaledWithoutOffset;
