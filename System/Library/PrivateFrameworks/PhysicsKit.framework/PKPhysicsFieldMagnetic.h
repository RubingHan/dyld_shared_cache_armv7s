...
+(id)fieldWithMagnet:(CGPoint)arg1 strength:(double)arg2 ;
+(id)fieldWithMagnet:(CGPoint)arg1 strength:(double)arg2 minRadius:(double)arg3 ;
-(void)setOffset:(CGPoint)arg1 ;
-(CGPoint)offset;
-(bool)isTangential;
-(void)setIsTangential:(bool)arg1 ;
-(id)initWithMagnet:(CGPoint)arg1 strength:(double)arg2 minRadius:(double)arg3 ;
-(double)minRadius;
