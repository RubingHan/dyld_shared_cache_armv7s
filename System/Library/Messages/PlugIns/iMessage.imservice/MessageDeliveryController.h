...
-(void)_sendMessage:(id)arg1 fromID:(id)arg2 fromAccount:(id)arg3 toID:(id)arg4 toSessionToken:(id)arg5 toPeople:(id)arg6 originallyToPeople:(id)arg7 type:(long long)arg8 completionBlock:(/*^block*/ id)arg9 ;
